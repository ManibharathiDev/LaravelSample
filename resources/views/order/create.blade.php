...
<div class="row">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="actionbutton">
            ...
            <form action="{{route('order.store')}}" method="post" id="subjectForm">
                {{csrf_field()}}
				<div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Order No <span class="required">*</span>
                    </label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="order_no" class="form-control col-md-12 col-xs-12" name="order_no"   required="required" type="text" value="{{$str_random}}" readonly>
				...
				<div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="order_date" class="form-control col-md-12 col-xs-12" name="order_date"  required="required" type="date">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="customer_no" class="form-control col-md-12 col-xs-12" name="customer_no"   required="required" type="text">
				...
				<div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="customer_name" class="form-control col-md-12 col-xs-12" name="customer_name"   required="required" type="text">
                ...
                <div class="form-group">
                    <div class="col-md-6">
                          <input type="hidden" name="rownumber"  id='rownumber' value='0' class='btn btn-success'>
