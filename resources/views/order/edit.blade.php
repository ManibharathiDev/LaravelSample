...
function  validate(id)
{
	...
	if(price>0 && discount>0){ price=price-discount;}
        ...
        <div class="actionbutton">
            ...
            <form action="{{route('order.update',$order->id)}}" method="post" id="subjectForm">
				...
				<div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="order_date" class="form-control col-md-12 col-xs-12" name="order_date"  required="required" type="date" value="{{$order->order_date}}">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="customer_no" class="form-control col-md-12 col-xs-12" name="customer_no"   required="required" type="text" value="{{$order->customer_no}}">
				...
				<div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="customer_name" class="form-control col-md-12 col-xs-12" name="customer_name"   required="required" type="text" value="{{$order->customer_name}}">
				...
				<a href="#" onclick="insRow()" >Add new Row</a>
                 <table id="POITable">
				 <thead>
				 <tr>
				 <th>#</th>
				 ...
				 ?>
				 <tr>
				 <td>#</td><th><input type='text' name='order[{{$sno}}][item]'  id='item{{$sno}}' value='{{$row->item}}' required></td>
					<td><input type='text' name='order[{{$sno}}][uom]' value='{{$row->uom}}' id='uom{{$sno}}'  required></td> 
				<td><input type='text' name='order[{{$sno}}][qty]' value='{{$row->quantitty}}' id='qty{{$sno}}' onblur='validate({{$sno}})' required></td>
				<td><input type='text' name='order[{{$sno}}][price]' value='{{$row->price}}' id='price{{$sno}}'  onblur='validate({{$sno}})'  required></td>
				<td><input type='text' name='order[{{$sno}}][discount]' value='{{$row->discount}}' id='discount{{$sno}}'  onblur='validate({{$sno}})'  required></td>
                ...
                <div class="form-group">
                    <div class="col-md-6">
                          <input type="hidden" name="rownumber"  id='rownumber' value='{{$sno}}' class='btn btn-success'>
